{
            ...
            Mask = {
                version = "1.11.0";
                url = "https://plugins.qgis.org/plugins/mask/version/1.11.0/download/";
                hash = "sha256-5WAzw1K+6pPGoCrbZtBo29rvYl8BQ68bF8+rEMnKToA=";
            };
            ...
            mmqgis = {
                version = "2024.11.8";
                url = "https://plugins.qgis.org/plugins/mmqgis/version/2024.11.8/download/";
                hash = "sha256-6YxOzOkqUJ75q1rzi8nu0kgZRlxLsnRjqp2vKI4SEoI=";
            };
            ...
            Plugin-Reloader = {
                version = "0.17";
                url = "https://plugins.qgis.org/plugins/plugin_reloader/version/0.17/download/";
                hash = "sha256-zGEnZY8/wcDKSHvuyz2EAbA5vQlTLueUkDRh2HwVFIc=";
            };
            ...
            Qgis2threejs = {
                version = "2.8";
                url = "https://plugins.qgis.org/plugins/Qgis2threejs/version/2.8/download/";
                hash = "sha256-9SA13u4TPwz2IIYfG7A1QqsJ0VJG3D4QKBUnGuisHdo=";
            };
            ...
            QField-Sync = {
                version = "v4.14.1";
                url = "https://plugins.qgis.org/plugins/qfieldsync/version/v4.14.1/download/";
                hash = "sha256-sImxpPFFWT/uZt3MJ1vgus03XxpLhsxT6oJjFRtbcuo=";
            };
            ...
            Data-Plotly = {
                version = "4.2.0";
                url = "https://plugins.qgis.org/plugins/DataPlotly/version/4.2.0/download/";
                hash = "sha256-sdaiHKAFVlJ3ktyUap4tB/BUmoBd+9p0LeX84JvQbJo=";
            };
            ...
            LAStools = {
                version = "2.3.2";
                url = "https://plugins.qgis.org/plugins/LAStools/version/2.3.2/download/";
                hash = "sha256-6ivuwfJiGu7+LDhds+IH0T8FymI6rSWWpFF3RLcWJMY=";
            };
            ...
            Google-Earth-Engine = {
                version = "0.0.7";
                url = "https://plugins.qgis.org/plugins/ee_plugin/version/0.0.7/download/";
                hash = "sha256-mHXAGQ3HAIs6CfWaGyO6VUCS9m3YBDIvV5BOzjQaUcI=";
            };
